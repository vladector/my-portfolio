import { motion } from 'framer-motion'; // Или 'motion/react', если используешь новую версию
    ...
    >
      <svg viewBox="0 0 1000 1000" className="w-full h-full min-h-screen" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin slice">
        ...
        <motion.g 
            ...
            // ИСПРАВЛЕНО: mixBlendMode теперь идет напрямую без ключа style
            animate={{ mixBlendMode: theme.mixBlend as any }} 
